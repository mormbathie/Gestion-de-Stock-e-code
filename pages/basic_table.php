              ...
              <table class="table table-striped table-advance table-hover">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone"><i class="fa fa-question-circle"></i> QUANTITE STOCK</th>
                    <th><i class="fa fa-bookmark"></i> SEUIL MINIMAL</th>
                    <th><i class=" fa fa-edit"></i> SEUIL MAXIMAL</th>
                    <th><i class=" fa fa-edit"></i> DATE PEREMPTION</th>
                    <th>ACTIONS</th>
                  </tr>
                </thead>
                <?php
                ...
                <tbody>
                  <tr>
                    <td>
                      <a href="basic_table.html#"><?=$produit['DESIGNATION']?></a>
                    </td>
                    <td class="hidden-phone"><?=$produit['DESIGNATION']?></td>
                    <td>12000.00$ </td>
                    <td><span class="label label-info label-mini">Due</span></td>
                    <td><span class="label label-info label-mini">2021/05/04</span></td>
                    <td>
